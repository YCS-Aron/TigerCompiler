...
public class PrettyPrintVisitor implements Visitor
{
  ...
  {
	  this.isayln("getfield " + s.path + " " + s.descriptor);
	  return;
  }
  
  public void visit(codegen.bytecode.stm.Putfield s)
  { 
	  this.isayln("putfield " + s.path + " " + s.descriptor);
  }
  ...
  public void visit(codegen.bytecode.stm.pop s)
  {
	 this.isayln("pop");
	 return;	  
  }
  ...
  {
    this.isayln("aload " + (new Integer(s.index)).toString());
    return;
  }
  ...
  {
    this.isayln("astore " + (new Integer(s.index)).toString());
    return;
  }
  ...
  {
    this.isayln("iload " + (new Integer(s.index)).toString());
    return;
  }
  ...
  {
    this.isayln("istore " + (new Integer(s.index)).toString());
    return;
  }
  ...
  {
    this.isayln("ldc " + (new Integer(s.i)).toString());
    return;
  }
  ...
  // type
  public void visit(codegen.bytecode.type.Boolean b)
  {
	  this.say("B");
  }
  ...
  public void visit(codegen.bytecode.method.Method m)
  {
    ...
    for (codegen.bytecode.dec.T d : m.formals) {
      ...
      dd.type.accept(this);			//there is no DEC.accept()
    }
    this.say(")");
  ...
  public void visit(codegen.bytecode.classs.Class c)
  {
    ...
    for (codegen.bytecode.dec.T d : c.decs) {
      codegen.bytecode.dec.Dec dd = (codegen.bytecode.dec.Dec) d;
      this.say(".field public " + dd.id + " ");			//there is no DEC.accept()
      dd.type.accept(this);
      this.sayln("");
    }
